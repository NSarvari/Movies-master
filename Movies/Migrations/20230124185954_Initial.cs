    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CinemaMovie", x => new { x.CinemasCinemaId, x.MoviesMovieId });
                    table.ForeignKey(
                        name: "FK_CinemaMovie_Cinemas_CinemasCinemaId",
                        column: x => x.CinemasCinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "CinemaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CinemaMovie_Movies_MoviesMovieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CinemaMovie_MoviesMovieId",
                table: "CinemaMovie",
